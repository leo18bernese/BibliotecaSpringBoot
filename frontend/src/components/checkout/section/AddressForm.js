...
const AddressForm = ({addressData, handleChange, errors, errorRef}) => {
    ...
    } = useIMask(textMask, {onAccept: (value) => handleChange({target: {name: 'city', value}})});
    const {
        ref: countryRef,
        setValue: setCountryValue
    } = useIMask(textMask, {onAccept: (value) => handleChange({target: {name: 'country', value}})});
        ...
        <div className="space-y-4">
                ...
                {addressSuggestions.length > 0 && (
                    <ul className="absolute z-10 w-full bg-white border border-gray-300 rounded-md mt-1 max-h-60 overflow-auto">
                        {addressSuggestions.map((suggestion) => (
                            <li key={suggestion.place_id} className="p-2 hover:bg-gray-100 cursor-pointer"
            ...
            <div>
                ...
                <input ref={node => {
                    ...
                    if (errors.name) errorRef.current = node;
                }} type="text" name="name" value={addressData.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                    ...
                    <input ref={errors.address ? errorRef : null} type="text" name="address" value={addressData.address}
                ...
                <div>
                    ...
                    <input type="text" name="houseNumber" value={addressData.houseNumber} onChange={handleChange}
                           className={`mt-1 block w-full border-2 border-gray-200 rounded-md shadow-sm p-2 ${errors.houseNumber ? 'border-red-500' : ''}`}/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input ref={node => {
                        cityRef.current = node;
                        if (errors.city) errorRef.current = node;
                    }} type="text" name="city" value={addressData.city}
                ...
                <div>
                    ...
                    <input ref={node => {
                        postalCodeRef.current = node;
                        if (errors.postalCode) errorRef.current = node;
                    }} type="text" name="postalCode" value={addressData.postalCode}
            ...
            <div>
                ...
                <input ref={node => {
                    countryRef.current = node;
                    if (errors.country) errorRef.current = node;
                }} type="text" name="country" value={addressData.country}
