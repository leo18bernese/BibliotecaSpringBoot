    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // Endpoints pubblici
                        .requestMatchers("/api/auth/**", "/api/libri/**", "/api/categories/**", "/api/images/**", "/api/spedizione/**", "/api/recensioni/**", "/api/home/**", "/api/autori", "/api/rankings/**", "/h2-console/**", "/error").permitAll()
                        ...
                        .requestMatchers("/api/admin/**", "/api/rifornimento", "/api/analytics").hasRole("ADMIN")
